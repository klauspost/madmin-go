...
func TestMarshalUnmarshalSystemErrors(t *testing.T) {
	v := SystemErrors{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgSystemErrors(b *testing.B) {
	v := SystemErrors{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSystemErrors(b *testing.B) {
	v := SystemErrors{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSystemErrors(b *testing.B) {
	v := SystemErrors{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeSystemErrors(t *testing.T) {
	v := SystemErrors{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeSystemErrors Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeSystemErrors(b *testing.B) {
	v := SystemErrors{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeSystemErrors(b *testing.B) {
	v := SystemErrors{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
